...
function carregar() {
    ...
    browserEscondido.onload = function () {
        ...
        res.forEach(el => {
            ...
            <td>\
            <a href='/Gaan/index.php/familiares/detalhes/"+ el.idUser + "'>Mais detalhes</a>\
            </td>\
                </tr >";
        });
    ...
    browserEscondido.open("GET", "../Controllers/API/Familiares.api.php");
...
function filtrar() {
    ...
    if (nome === "" && apelido === "") {
        ...
        browserEscondido.open("GET", "../Controllers/API/Familiares.api.php?nome=" + nome + "&apelido=" + apelido);
        browserEscondido.send()
    }
}
