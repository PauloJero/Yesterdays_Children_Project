...
function atualizar(secao) {
    const dados = {
        secao: secao,
        idUser: document.getElementById('idUser').innerHTML
    }

    if (secao === "email") {
        emailAtual = document.getElementById("email").value;
        emailNovo = document.getElementById("confEmail").value;
        ...
        dados["emailAtual"] = emailAtual;
        dados["emailNovo"] = emailNovo;


    } else if (secao === "senha") {
        senhaAtual = document.getElementById("senha").value;
        senhaNova = document.getElementById("confSenha").value;
        ...
        if (senhaAtual === senhaNova) {
            alert("As senhas não podem ser iguais");
            return false;
        } else {
